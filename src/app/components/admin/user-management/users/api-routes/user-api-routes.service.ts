...
export class UserApiRoutesService {

  constructor(
    private routesService: RoutesService
  ) { }

  private controllerName = 'GetUserWithPagination';
  private getUsersAction = 'GetActiveUsers';



  getAllUserApi(params: any): Observable<any> {
