...
export class RoleComponent implements OnInit {
  ...
  getItemActions() {
    return [
      { buttonName: 'Edit', icon: 'fa fa-pencil', cssClass: 'btn btn-sm btn-primary', tooltip: 'Edit', isActive: true, isDisabled: false },
      { buttonName: 'Delete', icon: 'fa fa-trash', cssClass: 'btn btn-sm btn-danger', tooltip: 'Delete' },
    ];
  }
